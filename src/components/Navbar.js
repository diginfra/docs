...
function Navbar({ isDocs }) {
  ...
  const logo = (
    <a className="logo" href="/" aria-label="Diginfra logo">
      <img
  ...
  const login = (
    <a className="infra-navbar__menu-item--login" href="https://infra-dashboard.khulnasoft.com">
      Sign up / Log in
    </a>
  );
  ...
  const community = (showSidebar) => (
    <>
      <a
        ...
        href="https://github.com/diginfra/diginfra"
        target="_blank"
      ...
      <a
        ...
        href="https://www.diginfra.khulnasoft.com/community-chat"
        target="_blank"
  ...
  const outreach = (
    <>
      <a
        ...
        href="mailto:hello@diginfra.khulnasoft.com"
        target="_blank"
        rel="noreferrer"
      >
        hello@diginfra.khulnasoft.com
      </a>
      <a
        className="navbar-item"
        href="https://twitter.com/diginfra"
        target="_blank"
        rel="noreferrer"
      >
        Twitter
