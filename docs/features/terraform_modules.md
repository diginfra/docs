...
If you use the Diginfra [CI/CD integrations](/docs/integrations/cicd/#cicd-integrations), follow the instructions below to set the required environment variables.
